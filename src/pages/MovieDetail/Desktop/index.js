      ...
      <div className={classes.top}>
        ...
        <div className={classes.topInfo}>
          ...
          <div className={classes.shortInfo}>
            ...
            <p className={classes.movieName}><span className={classes.c18}>{data.maNhom}</span>{data.tenPhim}</p>
            <p>{`${data.thoiLuong ?? "120"} phút - ${danhGia} Tix`} - 2D/Digital</p>
          ...
          <div className={classes.rate}>
            ...
            <span>{data.danhGia} người đánh giá</span>
          </div>
        </div>
      </div>
